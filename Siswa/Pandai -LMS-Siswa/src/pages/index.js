...
export default function App() {
  ...
  return (
    <div className='flex flex-col h-screen w-full bg-[#FBFCFF] font-sans overflow-hidden relative'>
      {/* Konten Utama: Desktop Optimized Layout */}
      <div className='flex-1 overflow-y-auto no-scrollbar relative pt-4 max-w-7xl mx-auto w-full'>
      ...
      {/* Navigasi Bawah: Desktop Friendly Sidebar/Bottom Nav */}
      <div className='z-50 max-w-7xl mx-auto w-full'>
        <BottomNav activeTab={activeTab} onTabChange={setActiveTab} />
      </div>

      <div className='absolute bottom-1 left-1/2 transform -translate-x-1/2 w-64 h-1 bg-gray-800 rounded-full opacity-10 pointer-events-none z-50'></div>
    </div>
  );
}
